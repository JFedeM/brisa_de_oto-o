...
class ProductoSchema(ma.Schema):
    ...
    """
    class Meta:
        fields = ("id", "nombre", "precio", "stock", "imagen", "categoria")
...
def create_producto():
    ...
    categoria = request.json["categoria"] #Obtiene la categoria del producto del JSON proporcionado
    new_producto = Producto(nombre, precio, stock, imagen, categoria)  # Crea un nuevo objeto Producto con los datos proporcionados
