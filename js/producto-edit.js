...
createApp({
  data() {
    return {
      ...
      precio: 0,
      categoria: "",
      url: "https://fedem.pythonanywhere.com/productos/" + id,
    };
  },
  methods: {
    fetchData(url) {
      ...
      En el primer then, se convierte la respuesta en formato JSON mediante response.json(). Luego, en el segundo then, se accede a los datos obtenidos y se asignan a las propiedades de la instancia de Vue, como id, nombre, categoria, imagen, stock y precio.
    ...
    modificar() {
      /* Este código define la función modificar(). En esta función, se crea un objeto producto que contiene las propiedades nombre, categoria, precio, stock e imagen obtenidas de la instancia de Vue. Luego se define un objeto options que especifica las opciones para la solicitud HTTP.
